...
module eu_misc_flag_status_tb;
    ...
    initial begin
        ...
        if (flags_out[0] !== 1'b0) begin
            $display("FAIL eu_misc_flag_status CLC");
            $finish(1);
        end
        ...
        if (flags_out[0] !== 1'b1) begin
            $display("FAIL eu_misc_flag_status STC");
            $finish(1);
        end
        ...
        #1;
        if (flags_out[0] !== 1'b0) begin
            $display("FAIL eu_misc_flag_status CMC");
            $finish(1);
        end
        ...
        if (flags_out[9] !== 1'b1) begin
            $display("FAIL eu_misc_flag_status STI");
            $finish(1);
        end
        ...
        if (flags_out[9] !== 1'b0) begin
            $display("FAIL eu_misc_flag_status CLI");
            $finish(1);
        end
        ...
        if (flags_out[10] !== 1'b0) begin
            $display("FAIL eu_misc_flag_status CLD");
            $finish(1);
        end
        ...
        if (flags_out[10] !== 1'b1) begin
            $display("FAIL eu_misc_flag_status STD");
            $finish(1);
        end
