...
$core = @(
    ...
    "rtl/peripheral/vga_graphics_adapter/vga_port.sv",
    "rtl/peripheral/vga_graphics_adapter/vga_font_rom.sv",
    "rtl/peripheral/vga_graphics_adapter/vga_text_color.sv",
    "rtl/peripheral/vga_graphics_adapter/vga_text_intense.sv",
    "rtl/peripheral/vga_graphics_adapter/vga_graphics_adapter.sv",
    "rtl/ram.sv",
    "rtl/rom.sv",
    "rtl/soc_top.sv",
    "rtl/soc_top_tb.sv"
