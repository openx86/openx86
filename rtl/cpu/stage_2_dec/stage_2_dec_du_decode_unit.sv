...
module: stage_2_dec_du_decode_unit
create at: 2022-01-04 03:27:51
description: decode unit (模块名与文件名 stage_2_dec_du_decode_unit 一致)
*/
...
stage_2_dec_du_decode_prefix_all deocde_decode_prefix_all (
...
stage_2_dec_du_decode_x87_esc u_decode_x87_esc (
...
stage_2_dec_du_decode_opcode_x86 deocde_decode_opcode_x86 (
...
stage_2_dec_du_decode_field deocde_decode_field (
...
stage_2_dec_du_decode_mod_rm deocde_decode_mod_rm (
    .i_mod ( mod_rm_i_mod ),
    .i_rm ( mod_rm_i_rm ),
...
//     endcase
// end
stage_2_dec_du_decode_sib deocde_decode_sib (
    .i_sib ( sib_i_sib ),
    .i_mod ( sib_i_mod ),
...
stage_2_dec_du_decode_disp_imm deocde_decode_disp_imm (
