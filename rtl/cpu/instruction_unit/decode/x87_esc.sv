...
module x87_esc (    input  logic [ 7: 0]   i_b0,
    ...
    output logic [ 2: 0] o_reg, // 输出信号
    output logic [ 2: 0] o_rm, // 输出信号
    output logic [ 2: 0] o_esc_group, // 输出信号
    output logic [31: 0] o_opmask, // 输出信号
    output logic         o_modrm_required, // 输出信号
    output logic         o_memory_operand // 输出信号
);
    logic [ 7: 0] esc;
    logic [ 7: 0] mr;
