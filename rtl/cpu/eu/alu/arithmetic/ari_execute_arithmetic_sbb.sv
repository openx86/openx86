...
description: This module implements eu_alu_arithmetic_ari_execute_arithmetic_sbb.
*/
// ============================================================================
// eu_alu_arithmetic_ari_execute_arithmetic_sbb — 带借位减法（SBB）
// ----------------------------------------------------------------------------
// `result = operand_1 - operand_2 - carry_flag`
// 仅输出结果；标志位更新由上层统一实现。
// ============================================================================

module eu_alu_arithmetic_ari_execute_arithmetic_sbb #(
    BIT_WIDTH = 32
) (
