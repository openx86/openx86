...
description: stage_3_4_exe_mem — combinational bridge from EXE stage to MEM (LSU) inputs.
*/
// ============================================================================
// stage_3_4_exe_mem
// ----------------------------------------------------------------------------
// Passes EXE valid and LSU request / memory return paths into stage_4_mem.
// ============================================================================

module stage_3_4_exe_mem (
